...
import net.cyndeline.rlgraph.drawings.planar.orthogonal.representation.ArtificialRemover
import net.cyndeline.rlgraph.drawings.planar.orthogonal.representation.help.darts.{ArtificialDart, DefaultDart, SimpleDart, SplitDart}
...
class ArtificialRemoverSpec extends SpecImports {
  ...
  private implicit def dartToSet(dart: Dart[String]): Set[Dart[String]] = Set(dart)
